...
cat = df2.category_title.unique()
cat_views = df2.groupby('category_title')['views'].mean()[cat].values
cat_count =df2.category_title.value_counts()[cat]
